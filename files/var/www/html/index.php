...
?>
	...
	<video id="player" autoplay="true" controls="controls" preload="auto" poster="http://<?php echo $_SERVER["HTTP_HOST"]; ?>/img/channel_<?php echo $channel; ?>.jpg" width="100%" height="100%">
		<source type="application/x-mpegurl" src="//<?php echo $_SERVER["HTTP_HOST"]; ?>/hls/<?php echo $channel; ?>.m3u8" />
		<source type="rtmp/flv" src="rtmp://<?php echo $_SERVER["HTTP_HOST"]; ?>/live/<?php echo $channel; ?>">
	</video>
...
?>
	<video id="player" autoplay="true" controls="controls" preload="auto" poster="//<?php echo $_SERVER["HTTP_HOST"]; ?>/img/video_<?php echo str_replace(".mp4", ".jpg", $video); ?>" width="100%" height="100%">
		<source type="video/mp4" src="//<?php echo $_SERVER["HTTP_HOST"]; ?>/rec/<?php echo $video; ?>">
	</video>
